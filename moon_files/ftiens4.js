...
//      21 Mar 03 - Add jsaction (javascript action) for popup menu
//      12 Oct 04 - Add FRAMETARGET to show tree in different frames
 
// Definition of class Folder 
// ***************************************************************** 
function Folder(folderDescription, hreference, jsaction) //constructor 
{ 
  //constant data 
...
{ 
  ...
  { 
	if (USEFRAMES)
	  docW = docW + "<a href='" + this.hreference + "' TARGET=\"" + FRAMETARGET + "\" "
	else
	  docW = docW + "<a href='" + this.hreference + "' TARGET=_top "

        //docW = docW + " oncontextmenu=\"javascript:alert('hi');return false;\" "
    if (this.jsaction)
        docW = docW + this.jsaction + " "
...
function gFld(description, hreference, jsaction) 
{ 
  folder = new Folder(description, hreference, jsaction) 
  return folder 
} 
