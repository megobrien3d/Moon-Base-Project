...
// changed to use waitTime as input parameter  -- Zuwei
...
//var waitTime=10;                   // NUMBER OF SECONDS FOR PROGRESSBAR
...
function progressBarInit(  waitTime){

document.getElementById('basediv').innerHTML = 
 '&nbsp; <p>' + txt +
 ' &nbsp; <p> &nbsp; &nbsp;' +
 '<font size="+1" color="gray">Loading...Please wait ...</font>';;
...
Pid=setInterval('incrCount('+waitTime+')',95);
}
