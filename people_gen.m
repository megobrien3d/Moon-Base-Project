function myPeople = people_gen(N)
...
%% This calls the calories_needs function and gives each person the 
% number of calories they need in a day

myPeople = calories_needs(myPeople);
